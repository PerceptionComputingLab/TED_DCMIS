...
class Generator(nn.Module):
    ...
    def forward(self, content, latent_scale, domain_code):
        content, latent_scale, domain_code = self.layers_BCIN(
            content, latent_scale, domain_code
        )
...
class DiscriminatorDomain(nn.Module):
    ...
    def __init__(
        self, in_channels, domain_code_size, max_channels=512, kernel_size=4, stride=2
    ):
...
class DiscriminatorContent(nn.Module):
    ...
    def __init__(
        self, in_channels, domain_code_size, max_channels=512, kernel_size=3, stride=2
    ):
        ...
        self.conv_0 = nn.Conv2d(
            ...
            out_channels=self.in_channels * 2**1,
            kernel_size=kernel_size,
            stride=stride,
            padding=padding,
        )
        ...
        self.conv_1 = nn.Conv2d(
            in_channels=self.in_channels * 2**1,
            out_channels=self.in_channels * 2**2,
            kernel_size=kernel_size,
            stride=stride,
            padding=padding,
        )
        ...
        self.conv_2 = nn.Conv2d(
            in_channels=self.in_channels * 2**2,
            out_channels=self.in_channels * 2**3,
            kernel_size=kernel_size,
            stride=stride,
            padding=padding,
        )
        ...
        self.conv_3 = nn.Conv2d(
            in_channels=self.in_channels * 2**3,
        ...
        self.conv_4 = nn.Conv2d(
            in_channels=self.in_channels * 2**4,
            out_channels=1,
            kernel_size=kernel_size,
            stride=stride,
            padding=padding,
...
class ResBlockBCIN(nn.Module):
    ...
    def __init__(
        ...
        self.norm0 = BCIN(
            num_features=out_channels, domain_code_size=domain_code_size, affine=True
        )  # learnable
        self.norm1 = BCIN(
            num_features=out_channels, domain_code_size=domain_code_size, affine=True
        )  # learnable
...
class BCIN(nn.Module):
    ...
    def forward(self, x, domain_code):
        ...
        return (
            (x - x_mean[:, None, None, None]) / x_var[:, None, None, None]
        ) + bias_scaled[:, None, None, None]
