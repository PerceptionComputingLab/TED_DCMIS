...
def ensure_channel_width_height_depth(np_array):
    ...
    if len(np_array.shape) == 3:
        np_array = np_array.transpose(axis_order[0], axis_order[2], axis_order[1])
...
def normalize_range(img_array, max_value=255.0):
...
segmask_colors = {
    1: {"red": 206, "green": 24, "blue": 30},  # Red
...
def visualize_dataloader_with_masks(
    dataloader, max_nr_imgs=100, save_path=None, img_size=(256, 256), alpha=0.5
):
