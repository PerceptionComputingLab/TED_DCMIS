...
axs[1].plot(
    kd_ours_wn, label="KD + AKT + GVU", marker="o", linestyle="-", color="darkviolet"
)
axs[1].fill_between(
    x,
    np.array(kd_ours_wn) - kd_ours_wn_std,
    np.array(kd_ours_wn) + kd_ours_wn_std,
    alpha=0.2,
    color="darkviolet",
)
...
plt.legend(
    [KD, ED_GVU, ED, KD_AKT, KD_AKT_GVU],
