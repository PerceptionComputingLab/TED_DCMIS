...
plt.subplot(1, 5, 1)
plt.scatter(data2['x'], data2['y'], color='red', alpha=0.3, edgecolors='white', )
...
plt.subplot(1, 5, 2)
plt.scatter(data1['x'], data1['y'], color='blue', alpha=0.3, edgecolors='white', )
# plt.title('(b) Naive knowledge distillation', fontproperties=font_prop)
plt.xlabel('PC1', fontproperties=font_prop)
plt.ylabel('PC2', fontproperties=font_prop)

plt.subplot(1, 5, 3)
plt.scatter(data4['x'], data4['y'], color='orange', alpha=0.3, edgecolors='white', )
# plt.title('(c) Noise-injected distillation', fontproperties=font_prop)
plt.xlabel('PC1', fontproperties=font_prop)
plt.ylabel('PC2', fontproperties=font_prop)

plt.subplot(1, 5, 4)
plt.scatter(data3['x'], data3['y'], color='green', alpha=0.3, edgecolors='white', )
# plt.title('(d) Diffusion-aug distillation', fontproperties=font_prop)
plt.xlabel('PC1', fontproperties=font_prop)
plt.ylabel('PC2', fontproperties=font_prop)

plt.subplot(1, 5, 5)
plt.scatter(data5['x'], data5['y'], color='purple', alpha=0.3, edgecolors='white', )
